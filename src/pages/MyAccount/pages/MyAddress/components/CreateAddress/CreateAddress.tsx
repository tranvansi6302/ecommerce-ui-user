...
import { AddressRequest } from '~/@types/addresses.type'
...
export default function CreateAddress() {
    const { globalOpenCreateAddessDialog, setGlobalOpenCreateAddessDialog } = useContext(AppContext)
    ...
    const createAddressMutation = useMutation({
        mutationFn: (body: AddressRequest) => addressesService.createAddress(body)
    })
    const onSubmit = handleSubmit((data) => {
        ...
        createAddressMutation.mutate(finalData, {
            onSuccess: () => {
                ...
                setGlobalOpenCreateAddessDialog(false)
                reset()
            }
        })
    })
    ...
    return (
        <CustomDialog open={globalOpenCreateAddessDialog} setOpen={setGlobalOpenCreateAddessDialog}>
